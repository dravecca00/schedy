...
try {
    ...
    $ical->initUrl('https://calendar.google.com/calendar/ical/ravecca%40gmail.com/private-59e32e6044fcbb978e14e4bf6a66b297/basic.ics', $username = null, $password = null, $userAgent = null);
} catch (\Exception $e) {
    die($e);
}
?>
        ...
        <div class="col-md-4">
            <div class="thumbnail">
                <div class="caption">
                    ...
                    ?></h3>
                    <?php echo $event->description;//var_dump($event);?>
                </div>
            </div>
        </div>
        <?php
